...
import { AccountEntity } from '../databases/postgresql/entities/account.entity';
import { AppEntity } from '../databases/postgresql/entities/app.entity';
...
describe('ClientService', () => {
  ...
  it('should create a client (Equal)', async () => {
    ...
    // Act
    const clientCreated = await service.create(client);
